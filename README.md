...
This repository contains the Stage 1–5 still-image vertical slice plus Stage 6 live media
on Plasma (Easel wallpaper plugin host): decode/fit/raster with
...
preview and affected workspace pages) for review. Additional Linux desktops and macOS packaging
remain Stage 7.
