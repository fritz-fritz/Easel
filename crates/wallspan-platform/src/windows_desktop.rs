...
fn rects_match(left: wallspan_core::LogicalRect, right: wallspan_core::LogicalRect) -> bool {
    left.x == right.x
        && left.y == right.y
...
pub fn plan_monitor_assignments(
    monitors: &[(String, wallspan_core::LogicalRect)],
...
mod tests {
    ...
    fn assignment_plan_matches_geometry() {
        ...
        let displays = vec![DisplayWallpaper {
            ...
            path: PathBuf::from(r"C:\wallspan\right.png"),
        ...
        assert_eq!(planned[0].1, PathBuf::from(r"C:\wallspan\right.png"));
    }
}
