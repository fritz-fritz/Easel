...
- Plasma may consume either a Plasma-oriented package or still-frame apply until the native
  bundle writer is complete; still-frame apply remains the safe default.
